...
public class GreetingServiceConfig {
	...
	FakeDataSource fakeDataSource(SfgConfiguration sfgConfiguration) {
		...
		fakeDB.setUserName(sfgConfiguration.getUserName());;
		fakeDB.setPassword(sfgConfiguration.getPassword());
		fakeDB.setDatasourceUrl(sfgConfiguration.getDatasourceUrl());
		return fakeDB;
	}
