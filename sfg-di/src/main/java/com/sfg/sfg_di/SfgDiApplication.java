...
import com.sfg.sfg_di.config.SfgConstructorConfig;
...
public class SfgDiApplication {
	...
	public static void main(String[] args) {
		...
		SfgConstructorConfig sfgConst = ctx.getBean(SfgConstructorConfig.class);
		System.out.println(sfgConst.getUserName()+" "+sfgConst.getPassword()+" "+sfgConst.getDatasourceUrl());
